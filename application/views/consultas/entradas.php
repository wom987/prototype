    ...
    <div class="card">
        ...
        <div style="padding: 20px;">         
            <table  class="table table-bordered">
                ...
                <form action="<?php echo base_url('consultas/print_entradas')?>" method="post" target="_blank" id="data">
                    <tbody id="reporte">
...
<script type="text/javascript" src="<?= base_url() ?>js/entradas.js" ></script>