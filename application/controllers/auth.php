...
class Auth extends CI_Controller
{
	...
	function login()
	{
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			$this->session->set_flashdata('msg', 'Su usuario ha sido deshabilitado.');					
			...
			if ($this->tank_auth->is_max_login_attempts_exceeded($login)) {	
				$this->session->set_flashdata('msg', 'Su equipo ha sido bloqueado. <br> Notifique al administrador del sistema.');
			...
			if ($this->form_validation->run()) {								// validation ok
				if ($this->tank_auth->login(
					...
					if (isset($errors['banned'])) {								// banned user
						...
						//redirect('/auth/send_again/');
						$this->session->set_flashdata('msg', 'Su usuario ha sido dado de baja.');
	...
	function register()
	{
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			$this->form_validation->set_rules('confirm_password', 'Confirmar', 'trim|required|xss_clean|matches[password]');
