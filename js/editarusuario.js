$(document).ready(function () {
    ...
    function save(){
        if(requeridos()){
            ...
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: url + 'configuraciones/editar',
    ...
    function requeridos(){
        ...
        if ($("#field_estado").val()==null) {
            $("#errorfield_estado").html("Campo requerido");            
            $("#errorfield_estado").fadeIn( tiempo, function() {});
            regresar = false;
        }
        ...
        if($("#field_password").val()!='' || $("#field_cPassword").val()!=''){
    ...
    $("#field_estado").change(function(){
        $("#errorfield_estado").fadeOut( tiempo, function() {});
    });
